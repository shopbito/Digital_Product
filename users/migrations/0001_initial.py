# Generated by Django 4.2.1 on 2023-06-09 17:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'a user with that username already exists.'}, help_text='required. 30 characters or fewer starting with a letter.letters', max_length=32, unique=True, validators=[django.core.validators.RegexValidator('^[a-zA-Z][a-zA-Z0-9_\\.+$', 'Enter a valid username starting with a-z.This value may contain only letters,number.and underscore characters.', 'invalid')], verbose_name='username')),
                ('first_name', models.CharField(blank=True, max_length=30, verbose_name='first name')),
                ('last_name', models.CharField(blank=True, max_length=30, verbose_name='last name')),
                ('email', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name='email address')),
                ('phone_number', models.BigIntegerField(blank=True, error_messages={'unique': 'A user with this moblie number already exists.'}, null=True, unique=True, validators=[django.core.validators.RegexValidator('^989[0-3,9]\\d{8}$', 'Enter a valid mobile number.')], verbose_name='mobile number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='', verbose_name='avtar')),
                ('birthday', models.DateField(blank=True, verbose_name='birthday')),
                ('gender', models.BooleanField(blank=True, help_text='female is False,male is True, null is unset', max_length=30, verbose_name='gender')),
